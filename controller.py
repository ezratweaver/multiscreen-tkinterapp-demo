from secondscreen import SecondScreen, FirstScreen, window
...
class Controller:
    def firstscreen_button_check():
        ...
        window.after(10, Controller.firstscreen_button_check)
    ...
    def secondscreen_button_check():
        ...
        window.after(10, Controller.secondscreen_button_check)
